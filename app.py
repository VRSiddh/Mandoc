...
os.environ["ANTHROPIC_API_KEY"] = "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"
...
def answer_question(query, vector_store):
    ...
    try:
        # Initialize Groq LLM
        llm = ChatAnthropic(
        model="claude-3-7-sonnet-20250219",  # Or "claude-3-opus-20240229", etc.
        temperature=0.1,
        max_tokens=2048,
        )
